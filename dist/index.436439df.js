...
const loadRecipe = async function(id) {
    try {
        ...
        //console.error(`${err}`);
        throw err; //propagandate the error so we will access catch block at controller.js
    }
};
...
const uploadRecipe = async function(newRecipe) {
    try {
        ...
        const ingredients = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith('ingredient') && entry[1] !== ''
            ...
            if (ingArray.length !== 3) throw new Error('Wrong input form! Please use the correct format!');
...
const KEY = 'd1ef55a6-5f25-46f4-9d08-e48601a875a8';
...
const AJAX = async function(url, uploadData) {
    try {
        ...
        throw err; //this way unfulfilled promise will get reject, otherwise it will be fulfilled even an error happens
    }
}; /*
...
var _iconsSvg = require("url:../../img/icons.svg"); //Parcel version 2 format
...
exports.default = new RecipeView(); //nese e kishim bo export komplet klasen, ish dasht te controller.js --> showRecipe(){
...
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class ResultsViews extends _viewJsDefault.default {
...
class PaginationView extends _viewJsDefault.default {
    ...
    _generateMarkup() {
        ...
        const buttonsNr = [];
        for(let i = 1; i < numPages; i++)buttonsNr.push(i);
        ...
        //Other page (somewhere in between- previus + next)
...
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class BookmarksViews extends _viewJsDefault.default {
